...
export const UnstableSiriOrb: React.FC<IUnstableSiriORB> &
  ...
  ({
    ...
    const noiseIntensitySV = useSharedValue(noiseIntensity);
    ...
    useEffect(() => {
      noiseIntensitySV.value = withTiming(noiseIntensity, { duration: 300 });
    }, [noiseIntensity]);
    ...
    const uniforms = useDerivedValue<Uniforms>(() => ({
      ...
      noiseIntensity: noiseIntensitySV.value,
      glowIntensity,
      saturation,
      brightness,
      rotationSpeed,
